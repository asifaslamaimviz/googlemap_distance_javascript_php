    ...
    <div class="wrapper">
        <form action="!" id="formDestination">
            <div class="form-group">
                <label>Origin: </label>
                <input type="text" id="fromPlaces" name="" class="form-control" placeholder="Enter a location"
                    value="" />
            </div>
            <div class="form-group">
            ...
            <input type="submit" value="Get Distance" class="btn btn-primary" id="submitDestination">
        </form>
        <form method="post" action="distance_api.php">

            <div class="data-box">
                <!-- <div id="result2" class="box"></div> -->
                <!-- <input type="text" id="nameofid" name="nameofid" class="form-control" readonly
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="200" type="text" name="pick_add_line" class="form-control"
            ...
            <div class="row setup-content" id="step-3">
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="control-label">Address Line</label>
                            <input maxlength="200" type="text" name="drop_add_line" class="form-control"
                                placeholder="Enter Address Line" />
                        </div>
                        <div class="form-group">
                            <label class="control-label">City</label>
            ...
            <div class="row setup-content" id="step-4">
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <input type="submit" name="save" value="Insert To Database">
